...
of this subset is smaller than or equal to W. You cannot break an item, either pick the 
...
value array val[], and the number of items n as a parameter and returns the maximum 
